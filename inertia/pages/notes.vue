<template>
  ...
  >
    <div class="bubble-menu">
      <Button size="small" @click="editor.chain().focus().toggleHeading({ level: 2 }).run()" :outlined="!editor.isActive('heading', { level: 2 })">
        <span class="material-icons-outlined">title</span>
      </Button>
      <Button size="small" @click="editor.chain().focus().toggleBold().run()" :outlined="!editor.isActive('bold')">
        <span class="material-icons-outlined">format_bold</span>
      </Button>
      <Button size="small" @click="editor.chain().focus().toggleItalic().run()" :outlined="!editor.isActive('italic')">
        <span class="material-icons-outlined">format_italic</span>
      </Button>
      <Button size="small" @click="editor.chain().focus().toggleStrike().run()" :outlined="!editor.isActive('strike')">
        <span class="material-icons-outlined">format_strikethrough</span>
      </Button>
      <Button size="small" @click="editor.chain().focus().toggleBulletList().run()" :outlined="!editor.isActive('listItem')">
