...
<template>
  <Card
    class="group hover:bg-surface-100 hover:dark:bg-surface-800"
    ...
    <template #header>
      ...
      >
        ...
        <template v-else>
          ...
          <span
            class="text-6xl! text-yellow-300 material-icons"
        ...
        <Tag
          class="absolute z-10 top-2 right-2 group-hover:dark:bg-surface-900 group-hover:bg-surface-0"
          severity="secondary"
          :value="type"
        />
        <Link
