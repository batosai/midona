...
<template>
  <Tooltip :placement="tooltipPlacement">
    <template #trigger>
      <media-mute-button
        class="ring-media-focus group relative -mr-1.5 inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-md outline-hidden ring-inset hover:bg-white/20 data-focus:ring-4"
      >
